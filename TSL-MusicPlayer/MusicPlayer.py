...
def Volume_ctr(self=None):
    wmp.settings.Volume = vio_scale.get()


def Volume_add(i=None):
    try:
        if i is None:
            i = [0]
